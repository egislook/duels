...
module.exports.getLightFromSteam = getLightFromSteam;
...
function getLightFromSteam(method, callback){
    var methods = {
        'heroes' : apiOpts.holder +'IEconDOTA2_570/GetHeroes/v0001/?key='+apiOpts.key+'&language=en_us',
    ...
    request(url, function (error, response, body) {
        if (!error && response.statusCode == 200) {
            ...
            callback('cannot get light data from steam api');
    });
}

var market = {
	"trash" : 'appid:570 rare NOT Recipe NOT inscribed NOT Taunt NOT heroic NOT Treasure NOT set NOT Mega NOT jack NOT announcer NOT artificer NOT cruel',
	...
	"corrupted" : 'appid:570 corrupted NOT runic NOT Shard'
}
...
function getFromSteam(id, method, callback, page){
	...
	if(id){
        ...
        var methods = {
            ...
            'userStats' : 'https://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/V001/?key='+apiOpts.key+'&account_id='+apiOpts.steamid
        }
